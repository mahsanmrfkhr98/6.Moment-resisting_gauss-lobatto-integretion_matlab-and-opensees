...
#####################################################################################################################################################################################################						       
	...
	# Create Cross-section for Beam-Column Elements:  section  Fiber  section#  {  patch  Typerquad   Assigned_Material#       Number_of_Fibers_in_h    Number_of_Fibers_in_w                yk    xk
...
######################################################################################################################################################################################################										
	...
	# Create Beam-Column Elements:                    element  dispBeamColumn  Element#   LNode        RNode       NumberOfIntegrationPoints  section  num.Transformer integration  TYPe of Integration
                                                      ...
                                                      element  dispBeamColumn     2          2           3                   4                   1           2        -integration      Lobatto
                                                      element  dispBeamColumn     3          3           4                   4                   1           3        -integration      Lobatto
                                                      element  dispBeamColumn     4          4           5                   4                   1           4        -integration      Lobatto
...
# Define Loads
	...
	# Create  loads:         																					     load  Node#  X_Value         Y_Value      Moment_Value
																												     load    2     2100000.0          0.0               0.0
																												     load    3        0.0       -300000.0               0.0
																												     load    4        0.0          0.0            -100000.0
																												  }
